...
/***/ (function(module, exports, __webpack_require__) {
	...
	var movies = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hideLoggedInForms = function hideLoggedInForms() {
	...
	var hideMovieForms = function hideMovieForms() {
	  $('#change-password').hide();
	  $('#sign-out').hide();
	  $('#save-movie').hide();
	  $('#get-movie').hide();
	...
	var clearMovieForms = function clearMovieForms() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateMovie = function onCreateMovie(event) {
	  var data = { 'movie': getFormFields(this) };
	  event.preventDefault();
	  api.saveMovie(data).then(ui.saveMovieSuccess).catch(ui.saveMovieFailure);
	};

	var onSaveMovie = function onSaveMovie(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.saveMovie(data).then(ui.saveMovieSuccess).catch(ui.saveMovieFailure);
	};
	...
	var onGetMovies = function onGetMovies(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.getMovies(data).then(ui.getMovieSuccess).catch(ui.getMovieFailure);
	};

	var onDeleteMovie = function onDeleteMovie(event) {
	  event.preventDefault();
	  $('.display-movies').empty();
	  api.deleteMovie(this.id);
	};

	var onUpdateMovie = function onUpdateMovie(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.updateMovie(data).then(ui.updateMovieSuccess).catch(ui.updateMovieFailure);
	};

	var clearMovieForm = function clearMovieForm() {
	  $('#save-movie').trigger('reset');
	  $('#get-movie').trigger('reset');
	...
	var hideMovieForm = function hideMovieForm() {
	  $('#update-movie').hide();
	  $('#get-movie').hide();
	  $('#delete-movie').hide();
	  $('#save-movie').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var saveMovie = function saveMovie(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies/',
	    method: 'POST',
	    headers: {
	...
	var updateMovie = function updateMovie(data) {
	  var submitData = { 'movie': data };
	...
	var getMovies = function getMovies(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies/',
	    method: 'GET',
	    headers: {
	...
	var deleteMovie = function deleteMovie(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showMovies = __webpack_require__(15);

	var saveMovieSuccess = function saveMovieSuccess(data) {
	  $('#message').text('movie created succesfully!');
	};

	var saveMovieFailure = function saveMovieFailure(error) {
	  $('#message').text('Error Saving Movie', error);
	};

	var getMovieSuccess = function getMovieSuccess(data) {
	  var onShowMovies = showMovies({ movies: data.movies });
	  $('.display-movies').empty();
	  $('.display-movies').append(onShowMovies);
	  $('#message').text('Movies retrieved succesfully!');
	};

	var getMovieFailure = function getMovieFailure(data) {
	  $('#message').text('Failed to get movies');
	};
	var createMovieSuccess = function createMovieSuccess(data) {
	  // const onCreateMovie = createMovie({ movies: data.movies })
	  $('#message').text('Movies created succesfully!');
	};
	var createMovieFailure = function createMovieFailure(data) {
	  $('#message').text('Failed to get movies');
	};
	...
	var deleteMovieFailure = function deleteMovieFailure(data) {
	  $('#message').text('Unable to delete movie');
	};

	var updateMovieSuccess = function updateMovieSuccess(data) {
	  $('#message').text('Movie succesfully updated!');
	};
	var updateMoviePopulate = function updateMoviePopulate(data) {
	  console.log(data);
	  $('#update-movie').show();
	...
	var updateMovieFailure = function updateMovieFailure(data) {
	  $('#message').text('Unable to update movie');
	};

	module.exports = {
	  saveMovieSuccess: saveMovieSuccess,
	  saveMovieFailure: saveMovieFailure,
	  getMovieSuccess: getMovieSuccess,
	  getMovieFailure: getMovieFailure,
	  showMovies: showMovies,
	  deleteMovieSuccess: deleteMovieSuccess,
	  deleteMovieFailure: deleteMovieFailure,
	  ...
	  updateMoviePopulate: updateMoviePopulate
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\n  <ul data-id=\""
	    ...
	    + "\">\n  <div"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.movie : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n    <div"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.title : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n    <div"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n    <div"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n      <div"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1),{"name":"if","hash":{},"fn":container.program(18, data, 0, blockParams),"inverse":container.program(20, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n<a class= \"edit-movie\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" href=\"#\"> Edit Movie </a>\n<a class= \"delete-movie\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" href=\"#\"> Delete Movie </a>\n<br>\n\n<br>\n  </ul>\n";
	  ...
	  return "\n    <large>Movie: "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.movie : stack1), depth0))
	    + "</large>\n";
	  ...
	  return "\n      <large>Length: "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.length : stack1), depth0))
	    + "</large>\n";
